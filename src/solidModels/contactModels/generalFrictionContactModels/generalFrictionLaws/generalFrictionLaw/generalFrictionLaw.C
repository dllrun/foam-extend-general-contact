...
defineTypeNameAndDebug(generalFrictionLaw, 0);
defineRunTimeSelectionTable(generalFrictionLaw, dictionary);


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

// Construct from dictionary
generalFrictionLaw::generalFrictionLaw
(
    const word& name,
    const generalFrictionContactModel& generalFrictionContactModel,
    const dictionary& dict
)
:
    frictionModel_(generalFrictionContactModel),
    frictionLawDict_(dict)
{}


// Construct as a copy
generalFrictionLaw::generalFrictionLaw(const generalFrictionLaw& fricLaw)
:
...
scalar generalFrictionLaw::slipTraction(const scalar pressure)
{
...
scalar generalFrictionLaw::slipTraction(const scalar pressure, const vector& slipDir)
{
...
scalar generalFrictionLaw::slipTraction
(
