...
namespace Foam
{
    defineTypeNameAndDebug(generalStandardPenaltyFriction, 0);
    addToRunTimeSelectionTable
    (
        generalFrictionContactModel,
        generalStandardPenaltyFriction,
        dictionary
    );
}
...
Foam::scalar Foam::generalStandardPenaltyFriction::frictionPenaltyFactor()
{
...
void Foam::generalStandardPenaltyFriction::calcFrictionPenaltyFactor()
{
	...
	*/	//*********(END problem exist) Choose this solid4Foam's ORG definitions ***********
    ...
    {
        FatalErrorIn("void generalStandardPenaltyFriction::calcPenaltyFactor() const")
...
Foam::generalStandardPenaltyFriction::generalStandardPenaltyFriction
(
    const word& name,
    const fvPatch& patch,
    ...
    contactIterNum_(0)
{
    ...
    (
        ...
        (
            frictionContactModelDict_.lookup("generalFrictionLaw"),
            *this,
...
Foam::generalStandardPenaltyFriction::generalStandardPenaltyFriction
(
    const generalStandardPenaltyFriction& fm
)
:
    generalFrictionContactModel(fm),
...
void Foam::generalStandardPenaltyFriction::correct
(
...
void Foam::generalStandardPenaltyFriction::autoMap(const fvPatchFieldMapper& m)
{
    ...
    if (debug)
    {
        InfoIn
        (
            "void generalStandardPenaltyFriction::autoMap(const fvPatchFieldMapper& m)"
        )   << "autoMap" << endl;
    }
...
void Foam::generalStandardPenaltyFriction::writeDict(Ostream& os) const
{
